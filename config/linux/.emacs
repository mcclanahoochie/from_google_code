;; Time-stamp: <2011-08-12 13:49:11 chris>
(setq
...
(defun astyle-this-buffer (pmin pmax)
  ...
  (shell-command-on-region pmin pmax
                           "astyle --style=java --indent=spaces --pad-oper --pad-header --add-brackets --keep-one-line-blocks --keep-one-line-statements --align-pointer=type "
                           (current-buffer) t
